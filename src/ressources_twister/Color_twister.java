...
public class Color_twister implements Serializable {
	...
	/**
	 * Constructeur de la classe Une couleur est composé de 3 valeurs numériques
	 * allant de 0 à 255 (rouge, vert, bleu)
	 */
	...
	// Méthodes
	/**
	 * Permet de limiter la valeur d'une couleur (toujours supérieure à 0 et
	 * inférieur à 255)
	 * 
	...
	public double DistanceEuclidienneCouleur(Color_twister x) {
		return Math.sqrt(Math.pow((this.red - x.getRed()), 2) + Math.pow((this.green - x.getGreen()), 2)
				+ Math.pow((this.blue - x.getBlue()), 2));
	}
